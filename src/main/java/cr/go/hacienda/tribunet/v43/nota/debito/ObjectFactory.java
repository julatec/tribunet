 ...
 * generated in the cr.go.hacienda.tribunet.v43.nota.debito package. 
...
public class ObjectFactory {
    ...
    private final static QName _EmisorTypeTelefono_QNAME = new QName("https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica", "Telefono");
    private final static QName _EmisorTypeFax_QNAME = new QName("https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica", "Fax");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cr.go.hacienda.tribunet.v43.nota.debito
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica", name = "Telefono", scope = EmisorType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica", name = "Fax", scope = EmisorType.class)
