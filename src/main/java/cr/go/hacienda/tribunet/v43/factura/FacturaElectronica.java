...
public class FacturaElectronica {
    ...
    @XmlElement(name = "LineaDetalle", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica")
    protected FacturaElectronica.DetalleServicio lineaDetalle;
