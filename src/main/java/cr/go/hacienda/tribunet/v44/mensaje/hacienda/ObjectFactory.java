 ...
 * generated in the cr.go.hacienda.tribunet.v44.mensaje.hacienda package. 
...
public class ObjectFactory {
    ...
    private static final QName _MensajeHaciendaTipoIdentificacionReceptor_QNAME = new QName("https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.4/mensajeHacienda", "TipoIdentificacionReceptor");
    private static final QName _MensajeHaciendaNumeroCedulaReceptor_QNAME = new QName("https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.4/mensajeHacienda", "NumeroCedulaReceptor");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cr.go.hacienda.tribunet.v44.mensaje.hacienda
     * 
     */
     ...
     * 
     * @return
     *     the new instance of {@link MensajeHacienda }
     */
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.4/mensajeHacienda", name = "TipoIdentificacionReceptor", scope = MensajeHacienda.class)
    public JAXBElement<String> createMensajeHaciendaTipoIdentificacionReceptor(String value) {
        return new JAXBElement<>(_MensajeHaciendaTipoIdentificacionReceptor_QNAME, String.class, MensajeHacienda.class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.4/mensajeHacienda", name = "NumeroCedulaReceptor", scope = MensajeHacienda.class)
    public JAXBElement<String> createMensajeHaciendaNumeroCedulaReceptor(String value) {
        return new JAXBElement<>(_MensajeHaciendaNumeroCedulaReceptor_QNAME, String.class, MensajeHacienda.class, value);
    }
