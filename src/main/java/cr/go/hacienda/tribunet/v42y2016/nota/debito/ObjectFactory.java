 ...
 * generated in the cr.go.hacienda.tribunet.v42y2016.nota.debito package. 
...
public class ObjectFactory {
    ...
    private final static QName _EmisorTypeTelefono_QNAME = new QName("https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/notaDebitoElectronica", "Telefono");
    private final static QName _EmisorTypeFax_QNAME = new QName("https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/notaDebitoElectronica", "Fax");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cr.go.hacienda.tribunet.v42y2016.nota.debito
     * 
     */
     ...
     * 
     */
    public NotaDebitoElectronica.InformacionReferencia createNotaDebitoElectronicaInformacionReferencia() {
        return new NotaDebitoElectronica.InformacionReferencia();
    }

    /**
     * Create an instance of {@link NotaDebitoElectronica.Normativa }
     * 
     */
    public NotaDebitoElectronica.Normativa createNotaDebitoElectronicaNormativa() {
        return new NotaDebitoElectronica.Normativa();
    }
     ...
     * 
     */
    public NotaDebitoElectronica.DetalleServicio.LineaDetalle createNotaDebitoElectronicaDetalleServicioLineaDetalle() {
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/notaDebitoElectronica", name = "Telefono", scope = EmisorType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/notaDebitoElectronica", name = "Fax", scope = EmisorType.class)
