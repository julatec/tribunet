 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="Identificacion" type="{https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/tiqueteElectronico}IdentificacionType"/&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="Ubicacion" type="{https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/tiqueteElectronico}UbicacionType"/&gt;
 *         &lt;element name="Telefono" type="{https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/tiqueteElectronico}TelefonoType" minOccurs="0"/&gt;
 *         &lt;element name="Fax" type="{https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/tiqueteElectronico}TelefonoType" minOccurs="0"/&gt;
...
@XmlType(name = "EmisorType", namespace = "https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/tiqueteElectronico", propOrder = {
        "nombre",
        "identificacion",
        "nombreComercial",
        "ubicacion",
...
public class EmisorType {
    ...
    @XmlElementRef(name = "Telefono", namespace = "https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/tiqueteElectronico", type = JAXBElement.class, required = false)
    protected JAXBElement<TelefonoType> telefono;
    @XmlElementRef(name = "Fax", namespace = "https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/tiqueteElectronico", type = JAXBElement.class, required = false)
