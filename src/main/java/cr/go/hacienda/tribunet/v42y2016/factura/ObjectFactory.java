 ...
 * generated in the cr.go.hacienda.tribunet.v42y2016.factura package. 
...
public class ObjectFactory {
    ...
    private final static QName _EmisorTypeTelefono_QNAME = new QName("https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/facturaElectronica", "Telefono");
    private final static QName _EmisorTypeFax_QNAME = new QName("https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/facturaElectronica", "Fax");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cr.go.hacienda.tribunet.v42y2016.factura
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/facturaElectronica", name = "Telefono", scope = EmisorType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/facturaElectronica", name = "Fax", scope = EmisorType.class)
