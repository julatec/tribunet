 ...
 * generated in the cr.go.hacienda.tribunet.v42y2016.nota.credito package.
...
public class ObjectFactory {
    ...
    private final static QName _EmisorTypeTelefono_QNAME = new QName("https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/notaCreditoElectronica", "Telefono");
    private final static QName _EmisorTypeFax_QNAME = new QName("https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/notaCreditoElectronica", "Fax");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cr.go.hacienda.tribunet.v42y2016.nota.credito
     */
     ...
     */
    @XmlElementDecl(namespace = "https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/notaCreditoElectronica", name = "Telefono", scope = EmisorType.class)
     ...
     * Create an instance of {@link JAXBElement }{@code <}{@link TelefonoType }{@code >}}
     */
    @XmlElementDecl(namespace = "https://www.hacienda.go.cr/ATV/docs/esquemas/2016/v4.2/notaCreditoElectronica", name = "Fax", scope = EmisorType.class)
