 ...
 * generated in the cr.go.hacienda.tribunet.v42y2017.nota.debito package. 
...
public class ObjectFactory {
    ...
    private final static QName _EmisorTypeTelefono_QNAME = new QName("https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica", "Telefono");
    private final static QName _EmisorTypeFax_QNAME = new QName("https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica", "Fax");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cr.go.hacienda.tribunet.v42y2017.nota.debito
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica", name = "Telefono", scope = EmisorType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica", name = "Fax", scope = EmisorType.class)
