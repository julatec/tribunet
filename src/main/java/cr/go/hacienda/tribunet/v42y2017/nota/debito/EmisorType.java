 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="Identificacion" type="{https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica}IdentificacionType"/&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="Ubicacion" type="{https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica}UbicacionType"/&gt;
 *         &lt;element name="Telefono" type="{https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica}TelefonoType" minOccurs="0"/&gt;
 *         &lt;element name="Fax" type="{https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica}TelefonoType" minOccurs="0"/&gt;
...
@XmlType(name = "EmisorType", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica", propOrder = {
    "nombre",
    "identificacion",
    "nombreComercial",
    "ubicacion",
...
public class EmisorType {
    ...
    @XmlElementRef(name = "Telefono", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica", type = JAXBElement.class, required = false)
    protected JAXBElement<TelefonoType> telefono;
    @XmlElementRef(name = "Fax", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaDebitoElectronica", type = JAXBElement.class, required = false)
