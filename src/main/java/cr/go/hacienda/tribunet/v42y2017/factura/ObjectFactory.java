...
// Generado el: 2020.08.27 a las 09:07:27 AM CST 
//


package cr.go.hacienda.tribunet.v42y2017.factura;
 ...
 * generated in the cr.go.hacienda.tribunet.v42y2017.factura package. 
...
public class ObjectFactory {
    ...
    private final static QName _EmisorTypeTelefono_QNAME = new QName("https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/facturaElectronica", "Telefono");
    private final static QName _EmisorTypeFax_QNAME = new QName("https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/facturaElectronica", "Fax");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cr.go.hacienda.tribunet.v42y2017.factura
     * 
     */
    ...
    /**
     * Create an instance of {@link FacturaElectronica.Normativa }
     * 
     */
    public FacturaElectronica.Normativa createFacturaElectronicaNormativa() {
        return new FacturaElectronica.Normativa();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/facturaElectronica", name = "Telefono", scope = EmisorType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/facturaElectronica", name = "Fax", scope = EmisorType.class)
