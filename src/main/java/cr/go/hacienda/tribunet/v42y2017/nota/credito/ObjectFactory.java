...
public class ObjectFactory {
    ...
    private final static QName _EmisorTypeTelefono_QNAME = new QName("https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaCreditoElectronica", "Telefono");
    private final static QName _EmisorTypeFax_QNAME = new QName("https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/notaCreditoElectronica", "Fax");
